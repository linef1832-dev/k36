// ════════════════════════════════════════════════════════════════════
// 📦 od_config/config.js — ส่วนที่ 1/2 ของตั้งค่า OD Form Bot (แยกจาก od_config.js เดิม 1,015 บรรทัด)
// เนื้อหา: ตั้งค่าบอททั้งหมด (ฟอร์ม, ปุ่ม, ข้อความ)
...
const OD_TPL_VARS = {
    ...
    lock:   ['{เว็บ}','{ยูส}','{ธนาคาร}','{เลขบัญชี}','{รายการบัญชี}','{จำนวนบัญชี}','{แท็ก}','{ผู้ส่ง}','{วันที่}','{เวลา}'],
...
const OD_TPL_SAMPLE = {
    ...
    lock:   { '{เว็บ}':'Jun88', '{ยูส}':'kaewoon1990', '{ธนาคาร}':'กสิกรไทย', '{เลขบัญชี}':'1234567890 กสิกรไทย', '{รายการบัญชี}':'1. 1234567890 กสิกรไทย\n2. 9876543210 กสิกรไทย', '{จำนวนบัญชี}':'2', '{แท็ก}':'@somchai @somsri', '{ผู้ส่ง}':'BIRD', '{วันที่}':'21/08/2569', '{เวลา}':'14:32' },
